...
tar_file="http://mirror1.ku.ac.th/ubuntu-cdimages/ubuntu-core/releases/$ubuntu_version/release/ubuntu-core-$ubuntu_version-core-$ubuntu_arch.tar.gz"
...
then
  ...
  tar_file="http://mirror1.ku.ac.th/ubuntu-cdimages/ubuntu-core/daily/current/$ubuntu_animal-core-$ubuntu_arch.tar.gz"
fi
